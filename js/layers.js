...
addLayer("d", {
 ...
 ["display-text",function() {
  ...
  if(hu("d",31)) a="20"
  if(hu("d",32)) a="1"
  if(hu("d",33)) a="0.00001"
  if(hu("d",34)) a="0"
  return "归乡的路程，还有 <h2 style='color:#f0f8ff; '>" + a + "</h2> 光年"
 }],"blank",
 "upgrades",
   ],},
   "剧情表": {
 ...
 cost:n(5),
 onPurchase() {
  player.p.points=new Decimal(5)
 },
 unlocked() {return hu("d",13)},
 ...
 cost:n(8),
 onPurchase() {
  player.p.points=new Decimal(8)
 },
 unlocked() {return hu("d",14)},
 currencyDisplayName:"聚变核心",
 currencyInternalName:"points",
 currencyLayer:"p",
   }, 
 ...
 cost:n(13),
 onPurchase() {
  player.p.points=new Decimal(13)
 },
 unlocked() {return hm("p",11)},
 currencyDisplayName:"聚变核心",
 currencyInternalName:"points",
 currencyLayer:"p",
   }, 
 ...
 cost:n(45),
 unlocked() {return hm("n",15)},
 currencyDisplayName:"中子定理",
 currencyInternalName:"theorems",
 currencyLayer:"n",
   }, 
   23:{ title: "第八次跳跃",
 description: "解锁“温暖 (Warmth)”<br>(你可以重置中子树恢复中子定理)",
 cost:n(60),
 unlocked() {return hm("n",18)},
 currencyDisplayName:"中子定理",
 currencyInternalName:"theorems",
 currencyLayer:"n",
   }, 
...
addLayer("h", {
 ...
 introduction0: {
  title: "游戏全局介绍",
  body(){return "欢迎大家游玩《2026春节树》！这里是作者QqQe308，这是一款以“春节归家”为情感内核的增量游戏。在游戏中，玩家将扮演一名远在星海之外的宇航员，通过独特的“航迹”积累与“距离”缩减双重进度系统，在纯文字与数值构成的宇宙中，踏上跨越光年的返乡旅途。游戏将情感叙事深度融入每一次资源解锁与升级之中，并用两个隐藏的字母密码串联起全部十二章旅程，旨在为玩家提供一段温暖且充满探索感的代码宇宙漫游。<br>游戏类型是“树类增量游戏”，如果你需要对树类游戏的介绍，请查看下方“树类游戏介绍”；本游戏有成就和“距离”系统，请查看右上角的黄色层级查看所有成就和“距离”；本游戏有剧情，分布在各个层级中，你可以先查看“剧情”标签页中的“剧情1”和“剧情2”；对于本层级的内容，请查看“Hope _ 希望”<br>感谢QqQe308的灵感与编程，感谢溜溜溜达嘿等群友的支持与催更，感谢Deepseek的剧情创作，感谢寒假，感谢春节，也感谢屏幕前的你<br>注意：本游戏尚未完结"},
   },
 introduction1: {
  title: "树类游戏介绍",
  body(){return "树类游戏是增量游戏的一种，在游戏中，各个“层级”是主要游玩内容，而高数量级的资源也是一大特点层级中的资源可以购买升级、完成挑战、提升可购买、达成里程碑等，游戏的画面和美工可能不够精美，但我会努力倾尽心力让内容精彩！"},
},
 text1: {
  title: "剧情1: 启航于宇宙归途(Embarkation) I",
  body(){return hm("d",0)?"欢迎，宇航员。<br>你漂泊于无垠深空，但一个目标清晰如灯塔：在春节前，努力回家。<br>前方是漫长的星际旅程，而你的航迹，始于当下。请尝试点击下方最显眼的按钮「凝聚希望」，并观察上方「航迹」数值的变化。这串数字是你所有努力的总和，是丈量你归途的根本尺度。<br>“每一点能量，都在将你推离漂泊，拉近家园。”<br>在右上角的子层级中，有一个至关重要的指标：「距离」，它代表你与家之间剩下的光年数，你的一切操作，最终都是为了看着它逐步缩减，直至归零。<br>“宇宙自有其节奏。当你准备好时，前路自会显现。”":"剧情暂未解锁"},
   },
 text2: {
  title: "剧情2: 启航于宇宙归途(Embarkation) II",
  body(){return hm("d",1)?"当希望粒子的微光在指尖汇聚，它们开始低语。<br>起初是杂乱的频率，如同星尘的噪音。<br>但随着数量增长，杂音逐渐沉淀，形成一段模糊的旋律。<br>我忽然想起，那是许多年前，某个团圆夜里，背景播放的熟悉曲调。<br>它并非来自飞船的数据库，而是从我记忆深处被唤醒。<br>此刻，控制台自动标注出一个新的读数。<br>它显示，这些粒子间的共鸣，正与某个遥远源头传来的、极其微弱的节律同步。<br>那源头的方向，与家园的坐标悄然重合。<br>宇宙的寂静并非虚无，它充满回响。<br>我收集的每一粒光，似乎都在加深我与那条归途之间的纽带。<br>继续下去。":"剧情暂未解锁"},
   },
 text3: {
  title: "剧情3: 启航于宇宙归途(Embarkation) III",
  body(){return hm("d",2)?"当航迹突破一千的刻度，仪表盘的嗡鸣声悄然改变了频率。<br>那种持续了许久的、稳定的积累感，在这一刻达到了临界。<br>我感到船舱内的光线被拉长，又压缩，一种并非由引擎产生的推力将我轻柔地按在座椅上。<br><br>窗外的星辰不再是静止的钻石，它们化作了流溢的光丝，向后飞逝。<br>飞船并未剧烈移动，而是它包裹的空间本身，在朝着家园的方向被轻轻“折叠”。<br>一次短促的时空跳跃。<br><br>跳跃结束的震颤平复后，首先映入眼帘的是导航屏上跳跃式缩减的距离读数。<br>一段切实的路程被跨越了。<br>然而，主能源舱的警报随之亮起——常规聚变引擎因这次维度变动而过载，输出功率正在衰减。<br><br>就在这动力青黄不接的寂静时刻，一道从未有过的读数闯入了监测范围。<br>在飞船前方，那个因跳跃而尚未完全平复的空间褶皱中，检测到了极端高能的粒子湮灭闪光。<br>那不是燃烧，是纯粹的“抹除”，并释放出星辰内核般的力量。<br>数据库将其标记为：反物质。<br><br>它就在那里，在空间的伤口中闪烁，是危机，也是唯一的出路。<br>常规的容器无法容纳它，我需要全新的协议来捕捉和利用这份宇宙中最危险也最强大的馈赠。<br><br>":"剧情暂未解锁"},
   },
 hope: {
  title: "Hope _ 希望",
  body(){return "希望(Hope)，这是旅途的起点，也是航迹的最初开端。你将在此收集资源，准备好进行下一次跳跃"},
   },
},
 name: "hope",
 symbol: "H",
 ...
 startData() {return {
  ...
  autoUpgrade() {return hm("P",2)&&player.P.auto2&&!player.e.inChal},
 layerShown(){return hu("d",11)},
 tabFormat: { 
   "希望": {
 content: [
  ["infobox","hope"],
 ...
 clickables:{
 	11: {
 title(){return "凝聚希望"},
 display: function() {return "点击获得"+format(getPointClick())+"航迹<br>冷却时间: "+formatTime(player.h.wait)},
 onClick() {
 player.points=player.points.add(getPointClick())
 player.h.wait=tmp.h.wait
 },
 canClick() {return player.h.wait.lte(0)&&!hu("h",25)},
 unlocked() {return true},
 style: {'width': '200px'},
   },
 	12: {
 title(){return "希望共振"},
 display: function() {return "消耗所有的希望，但接下来的"+format(tmp.h.duration)+"秒内，航迹获取量翻"+format(tmp.h.during)+"倍<br>剩余持续时间: "+formatTime(player.h.duration)},
 onClick() {
 player.h.duration=tmp.h.duration
 player.h.points=n(0)
 },
 canClick() {return player.h.duration.lte(0)&&player.h.points.gte(10)},
 unlocked() {return hm("p",2)},
 style: {'width': '200px'},
   },
 },
  upgrades: {
 ...
 unlocked() {return !inChallenge("e",12)},
 cost:n(1),
   }, 
   12:{ title: "经典升级",
 description: "希望粒子增加航迹获取量",
 cost:n(1),
 unlocked() {return (hu("h",11)||hu("a",52))&&!inChallenge("e",12)},
 effect() {
 ...
 cost:n(5),
 unlocked() {return (hu("h",12)||hu("a",52))&&!inChallenge("e",12)},
   }, 
   14:{ title: "走向前方",
 description: "航迹增加希望粒子获取量",
 cost:n(15),
 unlocked() {return (hu("h",13)||hu("a",52))&&!inChallenge("e",12)},
 effect() {
 ...
 cost:n(30),
 unlocked() {return (hu("h",14)||hu("a",52))&&!inChallenge("e",12)},
 effect() {
 ...
 cost:n(1000),
 unlocked() {return (hu("a",13)||hu("a",52))&&!inChallenge("e",12)},
   }, 
 22:{ title: "三次进展",
 description() {return inChallenge("e",13)?"凝聚希望冷却时间再次减半<br>在这个挑战中，购买完这一行升级有特殊效果":"凝聚希望冷却时间再次减半"},
 cost:n(1e7),
 unlocked() {return (hu("a",15)||hu("a",52))&&!inChallenge("e",12)},
   }, 
 23:{ title: "四次进展",
 description: "凝聚希望冷却时间再次减半",
 cost:n(1e8),
 unlocked() {return (hu("h",22)||hu("a",52))&&!inChallenge("e",12)},
   }, 
 24:{ title: "五次进展",
 description: "凝聚希望不再有冷却时间",
 cost:n(1e9),
 unlocked() {return (hu("h",23)||hu("a",52))&&!inChallenge("e",12)},
   }, 
 25:{ title: "持续进展",
 description() {return inChallenge("e",13)?"自动凝聚希望，速度为每秒20次，但禁用手动凝聚希望<br>另外，解锁第四个反应堆":"自动凝聚希望，速度为每秒20次，但禁用手动凝聚希望"},
 cost:n(1e10),
 unlocked() {return (hu("h",24)||hu("a",52))&&!inChallenge("e",12)},
   }, 
  },
})//希望 H
addLayer("a", {
  ...
  body(){return hm("d",3)?"空间跳跃的涟漪尚未完全平息，我就被推入了新的法则。<br>眼前的空间并非空无一物，它布满细微的裂痕，像一片被无形之力撞击过的冰面。<br>反物质的幽灵就在这些裂痕深处诞生、湮灭，闪烁著幽蓝的冷光。<br><br>它并非燃料，而是一种否定。否定质量，否定空虚，否定“存在”本身。<br>驾驭它，意味着要与这种终极的虚无共舞，并从其毁灭性的湮灭中，窃取照亮前路的光与驱动钢铁归家的力。<br><br>飞船的常规采集模块已自动下线，它们过于笨拙。<br>一套全新的、基于强磁场束缚与量子隧穿效应的协议正在载入。<br>它的图标在我的控制台上浮现，冰冷而精密，代表著与充满温度与思念的“希望”截然不同的力量层次。<br><br>这是宇宙的另一面，冷酷、高效、充满颠覆性的力量。<br>而我知道，要回家，我必须同时掌握光的温暖，与幽蓝的冰冷。<br>请建立与反物质的连接。":"剧情暂未解锁"},
   },
  text2: {
  title: "剧情5: 虫洞于时空转移(Transfer) II",
  body(){return hm("d",4)?"我关闭了虫洞的监测画面。<br>它的物理参数、不稳定性、辐射尾迹，所有数据都已下载完毕。<br>窗外的奇异光辉不再是一个景观，它变成了一串串冰冷的、可被方程解构的代码。<br><br>真正的转移，此刻才在船舱内开始。<br>我启动了第三座反物质反应堆。<br>它运行的原理，正是对窗外那个宇宙奇观的微观模仿：在磁场构筑的“微型时空”内，持续制造并控制着毫秒级的湮灭。<br><br>没有剧烈的跳跃，只有储备读数稳定而高效的攀升。<br>我从一个宇宙奇迹的仰望者，变成了它的学徒。<br>家，不是被“跳”过去的，而是被这种模拟奇迹的力量，一寸一寸拉近的。<br><br>工具，已经就位。":"剧情暂未解锁"},
   },
  text3: {
  title: "剧情6: 虫洞于时空转移(Transfer) III",
  body(){return hm("d",5)?"我松开了手指。<br>控制台上，“凝聚希望”的指令图标缓缓暗去，进入了常驻执行序列。<br><br>船舱内依然寂静，但一切都不同了。<br>我看不见它们，但我知道：每秒钟，有上亿的“希望”被自动析出、提纯，并注入反应链路；随之而来的是“航迹”如洪流般刷新，稳定得如同心跳；而在这一切的核心，那三座幽蓝的“湮灭核心”正无声运转，将一部分洪流转化为更危险、也更强大的基础力量。<br><br>我成了一个观察者。<br>这套由我亲手启动的、精密的因果之链，正在自行运转。它比我更专注，更高效，永不停歇。<br>归家的距离，正被这套系统，一秒一秒，确定地计算。<br><br>我望向窗外的虫洞，它依然在缓慢旋转，宏伟而神秘。<br>但我不再感到敬畏，反而感到一种奇异的亲近。<br>我的飞船内部，此刻也存在着一个微缩的宇宙：有希望作为星辰，有航迹作为时空，有反物质作为扭曲一切的力。<br><br>我并未闲下来。一个清晰的认知浮现在脑海：系统的效率，远未达到理论的极限。<br>优化的空间，如同眼前的星辰一样繁多。而下一步的关键……似乎在于如何让这股庞大的能量，更加“听话”。<br><br>工具已经自行运转。而工程师的下一项任务，是教会它们合唱。":"剧情暂未解锁"},
   },
  text4: {
  title: "剧情7: 虫洞于时空转移(Transfer) IV",
  body(){return hm("d",6)?"三座湮灭核心的出力曲线，在控制屏上终于收拢为三条笔直、稳固的线。<br>它们达到了当前框架的理论极限。<br>最后一项可购买的协议也已载入，系统日志被“优化完毕”的标记填满。<br><br>一切都在轰鸣。<br>希望、航迹与反物质，三者构成了一个完美闭合的黄金三角，如同一个微型的恒星系，在我的船舱内自治地、澎湃地运转。<br>我不再是操作员，而是这座小型宇宙的监看者。<br><br>但正是在这极致的效率中，我察觉到了新的瓶颈。<br>不是数量，是控制。<br>这股合成的洪流强大却粗糙，它推动我前进，却像用海啸去推动一枚指针。<br>为了走完最后、最精密的那段路，我需要的不再是更大的洪流，而是驾驭洪流的绝对精度——一种更基础、更稳定、能够为所有狂野力量定调的基础力量。<br><br>导航图闪烁起来。<br>一个早已标记，但直到此刻才被系统正式建议解锁的协议，在高亮闪烁。<br><br>虫洞的观测窗口在背后缓缓闭合。<br>关于“转移”的课程结束了。<br>下一堂课，名为“掌控”。":"剧情暂未解锁"},
   },
 antimatter: {
  title: "Antimatter _ 反物质",
  body(){return "反物质(Antimatter)，这是游戏中的第二个层级。在这里，你将消耗航迹，换来强大的反物质资源，以填充反应堆。每次重置还会获得一个虫洞，可用来购买升级。这是你建造的第一座“引擎室”，也是第三次跳跃的燃料。"},
   },
 annihilation: {
  title: "Annihilation _ 湮灭",
  body(){return "湮灭(Annihilation)，这是一个“桥梁”功能，获得1e24虫洞后，你可以湮灭虫洞，获得电子、质子和中子，概率分别为80%、10%、10%（湮灭虫洞达到一定量时，概率转为定比）"},
   },
},
 name: "antimatter",
 symbol: "A",
 ...
 if(layers.a.buyables[11].canAfford()&&layers.a.buyables[11].unlocked()) layers.a.buyables[11].buy()
 if(layers.a.buyables[12].canAfford()&&layers.a.buyables[12].unlocked()) layers.a.buyables[12].buy()
 if(layers.a.buyables[13].canAfford()&&layers.a.buyables[13].unlocked()) layers.a.buyables[13].buy()
   }
  },
  electron() {
   let ee=n(0.5)
   if(hu("y",44)) ee=n(0.6)
   let e=player.a.electron.max(1).pow(0.2)
  ...
  proton() {
   ...
   let e=player.a.proton.max(1).pow(0.6)
  ...
  neutron() {
   ...
   let e=player.a.neutron.max(1).pow(2.5)
  ...
  update(diff) {
 if(hu("P",13)) player.a.wormhole=player.a.wormhole.add(tmp.a.wormhole.mul(ue("P",13)).mul(diff))
  if(hu("a",45)) {
    player.a.electron=player.a.electron.add(layers.a.clickables[11].t().mul(diff).mul(0.8))
    player.a.proton=player.a.proton.add(layers.a.clickables[11].t().mul(diff).mul(0.1))
    player.a.neutron=player.a.neutron.add(layers.a.clickables[11].t().mul(diff).mul(0.1))
   }
  },
  autoUpgrade() {return hm("P",3)&&player.P.auto3&&!player.e.inChal},
 layerShown(){return hu("d",12)},
 tabFormat: { 
   "反物质": {
 content: [
  ["infobox","antimatter"],
  "main-display",
  ["display-text",function() {
  return "你有 <h2 style='color:#007033; '>" + format(player.a.wormhole) + "</h2> 虫洞"
 }],"blank",
  "prestige-button","resource-display",
  "buyables","blank",
  "upgrades",
 ...
 content: [
  ...
  ["display-text",function() {
  return "你有 <h2 style='color:#2df8eb; '>" + format(player.a.electron) + "</h2> 电子，虫洞获取量<h2 style='color:#2df8eb; '>×" + format(tmp.a.electron) + "</h2> "
 }],
  ["display-text",function() {
  return "你有 <h2 style='color:#e5ef54; '>" + format(player.a.proton) + "</h2> 质子，能量获取量<h2 style='color:#e5ef54; '>×" + format(tmp.a.proton) + "</h2> "
 }],
  ["display-text",function() {
  return "你有 <h2 style='color:#9893a8; '>" + format(player.a.neutron) + "</h2> 中子，思念获取量<h2 style='color:#9893a8; '>×" + format(tmp.a.neutron) + "</h2> "
 }],"blank",
  "prestige-button","resource-display",
  "clickables","blank",
  "upgrades",
   ],
 unlocked() {return hm("p",9)}
   },
   "剧情": {
 content: [
  "main-display","blank",
 ...
 title(){return "航迹反应堆 AR1"},//Antimatter Reactor
 display() {return "航迹的获取量×"+format(this.effect())+"<br>价格："+format(this.cost())+" 反物质<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
  let base=n(2)
  if(inChallenge("e",13)&&be("a",14).gte(1)) base=base.mul(be("a",14))
 ...
 title(){return "希望反应堆 AR2"},
 display() {return "希望粒子的获取量×"+format(this.effect())+"<br>价格："+format(this.cost())+" 反物质<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
   let base=n(1.8)
  if(inChallenge("e",13)&&be("a",14).gte(1)) base=base.mul(be("a",14))
 ...
 title(){return "反物质反应堆 AR3"},
 display() {return "反物质的获取量×"+format(this.effect())+"<br>价格："+format(this.cost())+" 反物质<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
  let base=n(1.6)
  if(inChallenge("e",13)&&be("a",14).gte(1)) base=base.mul(be("a",14))
...
if(inChallenge("e",11)) a=n(0)
 ...
 title(){return "奇异反应堆 AR4"},
 display() {return "前三个反应堆的底数+"+format(this.effect())+"<br>价格："+format(this.cost())+" 反物质<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
 ...
 buyMax() {
   ...
   unlocked() {return hu('h',25)&&inChallenge("e",13)},
   purchaseLimit() {
 let a=n(10)
if(inChallenge("e",11)) a=n(0)
 return a
  ...
  clickables:{
 	11: {
 title(){return "湮灭虫洞"},
 display() {return "湮灭你的所有虫洞，随机转化为"+format(this.t())+"个粒子(向下取整)"},
 t() {
  let e=n(0.1)
  if(hm("n",14)) e=n(0.12)
 ...
 canClick() {return player.a.wormhole.gte(1e24)},
 unlocked() {return hm("p",9)},
   },
  },
  upgrades: {
 ...
 description: "凝聚希望冷却时间再次减半",
 cost:n(3),
 unlocked() {return hu("a",11)||hu("a",51)},
   }, 
   13:{ title: "重构希望",
 ...
 currencyInternalName:"wormhole",
 currencyLayer:"a",
 unlocked() {return hu("a",12)||hu("a",51)},
   }, 
   14:{ title: "加速推进",
 description: "反物质增加航迹和希望粒子获取量",
 cost:n(15),
 unlocked() {return hu("a",13)||hu("a",51)},
 effect() {
 ...
 currencyInternalName:"wormhole",
 currencyLayer:"a",
 unlocked() {return hu("a",14)||hu("a",51)},
   }, 
   21:{ title: "虫洞传送",
 description: "虫洞增加反物质获取量",
 cost:n(1e7),
 unlocked() {return hu("a",15)||hu("a",51)},
 effect() {
 ...
 cost:n(1e10),
 unlocked() {return hu("a",21)||hu("a",51)},
 effect() {
 ...
 currencyInternalName:"wormhole",
 currencyLayer:"a",
 unlocked() {return hu("a",22)||hu("a",51)},
 effect() {
 ...
 currencyInternalName:"wormhole",
 currencyLayer:"a",
 unlocked() {return hu("a",23)||hu("a",51)},
 effect() {
 ...
 effectDisplay() {return "×"+format(ue(this.layer, this.id)) },
   ...
   25:{ title: "再启新篇",
 description: "[需求:购买至少50个反应堆]<br>航迹、希望粒子、反物质获取量都变为原来的10倍",
 tooltip: "你该去“距离”界面看看了",
 cost:n(1e13),
 canAfford() {return gba("a",11).add(gba("a",12)).add(gba("a",13)).gte(50)},
 unlocked() {return hu("a",24)||hu("a",51)},
   }, 
   31:{ title: "反向提升",
 description: "反物质增益能量获取量",
 cost:n(1e15),
 unlocked() {return hm("p",1)||hu("a",51)},
 effect() {
 ...
 cost:n(1e16),
 unlocked() {return hu("a",31)||hm("p",2)||hu("a",51)},
 effect() {
 ...
 cost:n(1e17),
 unlocked() {return hu("a",32)||hu("a",51)},
 effect() {
 ...
 cost:n(1e18),
 unlocked() {return hu("a",33)||hu("a",51)},
   }, 
   35:{ title: "宇宙能源",
 description: "虫洞获取量^1.2",
 cost:n(1e30),
 unlocked() {return hu("a",34)||hu("a",51)},
   }, 
   41:{ title: "物质融合",
 description: "每个反物质升级让反物质×1.1",
 cost:n(1e34),
 unlocked() {return hm("p",4)||hu("a",51)},
 effect() {
   let a = n(1.1).pow(player.a.upgrades.length)
   return a
 },
 ...
 cost:n(1e38),
 unlocked() {return hu("a",41)||hu("a",51)},
 effect() {
 ...
 currencyInternalName:"wormhole",
 currencyLayer:"a",
 unlocked() {return hu("a",42)||hu("a",51)},
 effect() {
 ...
 cost:n(1e54),
 unlocked() {return hu("a",43)||hu("a",51)},
 effect() {
 ...
 cost:n(1e200),
 unlocked() {return hu("a",44)||hu("a",51)},
   }, 
   51:{ title: "物质协议 I",
 description: "重新解锁所有反物质升级",
 cost:n(1e5),
 unlocked() {return inChallenge("e",11)},
   }, 
   52:{ title: "物质协议 II",
 description: "重新解锁所有希望升级",
 cost:n(1e6),
 unlocked() {return inChallenge("e",11)&&hu("a",51)},
   }, 
   53:{ title: "物质协议 III",
 description: "第七个能量条效果改为降低能量需求，且效果变成原来的五次方",
 cost:n(1e7),
  effect() {
 ...
 effectDisplay() {return "÷"+format(ue(this.layer, this.id)) },
 unlocked() {return inChallenge("e",11)&&hu("a",52)},
   }, 
   54:{ title: "物质协议 IV",
 description: "熵倍增资源倍率",
 cost:n(1e8),
 ...
 effectDisplay() {return "×"+format(ue(this.layer, this.id)) },
 unlocked() {return inChallenge("e",11)&&hu("a",53)},
   }, 
   55:{ title: "物质协议 V",
 ...
 effectDisplay() {return "÷"+format(ue(this.layer, this.id)) },
 unlocked() {return inChallenge("e",11)&&hu("a",54)},
   }, 
  },
})//反物质 A
...
addLayer("p", {
  ...
  body(){return hm("d",7)?"日志 - 协议转换<br>反物质流在约束场中达到临界密度。<br>执行最终指令：将所有储备注入“聚变点火协议”。<br>确认。<br>刹那间，前两层系统——希望的暖光与反物质的幽蓝——如潮水般褪去、归零。控制台陷入短暂的黑寂，仿佛宇宙深吸了一口气。<br>然后，它诞生了。<br>一点纯白、稳定、令人心安的辉光，在核心舱中央亮起。第一座聚变核心。它不像反物质那样危险嘶鸣，只是持续地、温和地辐射出磅礴而驯服的能量。<br>我感受到了前所未有的“力量”。这是一种扎实、可依赖的根基之力。<br>然而，飞船的原始系统传来反馈：这股能量过于平稳、过于庞大，现有的单一通道无法充分发挥其全部潜能。它需要一个更精密的导流网络，将其分配到不同的子系统，才能将这份“稳定”转化为“超越”的动力。<br>能量，已然就位。<br>下一阶段的蓝图，随之展开：我需要在这份稳定的丰饶中，构建一个最优的分配矩阵。<br>系统提示：“能量导流网络” 已上线。等待架构配置。":"剧情暂未解锁"},
   },
  text2: {
  title: "剧情9: 能量于稳态调和(Equilibrium) II",
  body(){return hm("d",8)?"日志 - 初始导流<br>三条能量通道已激活。<br>第一束能量注入导航核心。航迹的计量标尺被重新校准，每一段记录都承载了更深的时空重量。<br>第二束能量汇入生态循环。希望粒子的生灭节律变得稳定而迅捷，如同被赋予了更坚定的意志。<br>第三束能量反馈给星际燃料。那团纯白辉光的脉动，传来了更深沉有力的搏动。<br>一个最简的三角回路开始运转。飞船系统的“生命体征”正变得强健而沉稳。<br>能量，成了调节律动的血液。<br>系统提示：初级稳态达成。网络待命，等待更复杂的协同。":"剧情暂未解锁"},
   },
  text3: {
  title: "剧情10: 能量于稳态调和(Equilibrium) III",
  body(){return hm("d",9)?"日志 - 网络扩张<br>第四个聚变核心上线，能量流迎来了阶跃。<br>“希望共振”协议被激活——不再是零星的火花，而是持续的光谱。希望粒子的产生，变成了呼吸般自然的背景节律。<br>曾经稀缺如珍宝的虫洞坐标，如今在充裕能量的扫描下，显露出庞大的集群。它们不再是需要精打细算的冒险，而是可以规划开采的丰饶矿脉。<br>反应堆的上限闸门被一道道冲开。约束场的轰鸣声已连成一片低沉而持续的和弦，湮灭的幽蓝光芒稳定得如同另一种形态的日光。<br>能量网络自我增衍，寻找着新的平衡态。丰饶，带来了新的问题：如何分配，如何优化，如何将几何级数增长的能量，转化为指向家园的、绝对精准的矢量。<br>系统提示：稳态，从来不是静止。它是一种动态的、不断扩张的秩序。":"剧情暂未解锁"},
   },
  text4: {
  title: "剧情11: 能量于稳态调和(Equilibrium) IV",
  body(){return hm("d",10)?"日志 - 盈余质变<br>能量网络的产出已稳定超过所有已知消耗。那些无法被及时导流的能量，在储备回路中积聚、盈余，发出近乎白噪的微弱嗡鸣。<br>我意识到，纯粹的“分配”已触及瓶颈。当资源本身成为需要被管理的负担时，我需要的不再是更粗的管道，而是一个能理解所有管道、并自行决定阀门开合的智能。<br>我将盈余的能量，导向一个全新的区域。它们不再注入任何增长性的模块，而是开始构筑一种静默的、结晶般的逻辑单元阵列。每一个单元，都是一个问题求解器。<br>它们开始运作了。一种被命名为“处理通量”的抽象资源，如同思维的节拍，在阵列中诞生并流转。我看不见它，但能通过结果感知：希望粒子的收集开始在没有我干预的间隙中持续发生；基础升级的采购序列被自动排列与执行。<br>我从驾驶员，开始向监理者过渡。处理器阵列接管了“繁荣”本身的管理学。而我的任务，变成了为这个正在学会思考的系统，设定更高阶的目标——例如，家的方向。<br>系统提示：能量网络负载已达新阈值，‘处理器核心’初始化协议已在队列中就绪":"剧情暂未解锁"},
   },
 power: {
  title: "Power _ 聚变核心",
  body(){return "聚变核心(Power)，这是游戏中的第三个层级。虽然它会重置前两个层级的所有内容，但里程碑的效果会让这些操作更简单。另外，聚变核心还会生产能量，详见另一个标签页。"},
   },
 energy: {
  title: "Energy _ 能量",
  body(){return "能量(Energy)，这是聚变核心的主产物，随时间增长的同时，也可以被一些升级效果增加获取。能量可以被用来购买升级和填充能量条，能量条会促进前面的各种资源的获取。注：能量获取量超过1e10/秒的时候，增长会大大降低"},
   },
},
 name: "power",
 symbol: "P",
 ...
 startData() {return {
  ...
  energy() {
   ...
   if(hm("n",0)) a=a.add(1)
   if(hu("a",31)) a=a.mul(ue("a",31))
   if(hu("p",14)) a=a.mul(tmp.p.energyEffect[3])
   if(hu("a",43)) a=a.mul(ue("a",43))
   if(hu("p",35)) a=a.mul(ue("p",35))
   if(hu("y",42)) a=a.mul(ue("y",42))
   if(hu("n",42)) a=a.mul(ue("n",42))
   if(hm("p",9)) a=a.mul(tmp.a.proton)
   if(hu("n",61)) a=a.mul(ue("n",61))
   if(hu("n",71)) a=a.mul(ue("n",71))
   if(hu("n",81)) a=a.mul(ue("n",81))
   if(hu("n",91)) a=a.mul(ue("n",91))
   if(player.n.mult.gte(0)) a=a.mul(player.n.mult)
  ...
  energyLevelNext() {
   let a=n(1)
   if(hu("p",22)) a=a.mul(tmp.p.energyEffect[6])
   let next=[]
   for (let i = 0; i < 8; i++) {
  next.push(tmp.p.energyLevelBase[i].pow(player.p.energyLevel[i].add(1).floor()).div(a));
 }
   return next
  },
  energyEffect() {
   let effect=[
   n(1.5).pow(player.p.energyLevel[0]),
   n(1.35).pow(player.p.energyLevel[1]),
   n(1.25).pow(player.p.energyLevel[2]),
   n(1.6).pow(player.p.energyLevel[3]),
   (player.p.energyLevel[4]),
   n(1.8).pow(player.p.energyLevel[5]),
   n(1.4).pow(player.p.energyLevel[6]),
   n(1.2).pow(player.p.energyLevel[7]),
   ]
   if(hm("p",5)) effect=[
   n(1.5).pow(player.p.energyLevel[0].add(player.p.energyDrain[0].div(tmp.p.energyLevelNext[0]).min(1))),
   n(1.35).pow(player.p.energyLevel[1].add(player.p.energyDrain[1].div(tmp.p.energyLevelNext[1]).min(1))),
   n(1.25).pow(player.p.energyLevel[2].add(player.p.energyDrain[2].div(tmp.p.energyLevelNext[2]).min(1))),
   n(1.6).pow(player.p.energyLevel[3].add(player.p.energyDrain[3].div(tmp.p.energyLevelNext[3]).min(1))),
  (player.p.energyLevel[4]),
   n(1.8).pow(player.p.energyLevel[5].add(player.p.energyDrain[5].div(tmp.p.energyLevelNext[5]).min(1))),
   n(1.4).pow(player.p.energyLevel[6]),
   n(1.2).pow(player.p.energyLevel[7].add(player.p.energyDrain[7].div(tmp.p.energyLevelNext[7]).min(1))),
   ]
   if(hm("p",5)&&hu("p",31)) effect=[
   n(1.5).pow(player.p.energyLevel[0].mul(1.2).add(player.p.energyDrain[0].div(tmp.p.energyLevelNext[0]).min(1))),
   n(1.35).pow(player.p.energyLevel[1].mul(1.2).add(player.p.energyDrain[1].div(tmp.p.energyLevelNext[1]).min(1))),
   n(1.25).pow(player.p.energyLevel[2].mul(1.2).add(player.p.energyDrain[2].div(tmp.p.energyLevelNext[2]).min(1))),
   n(1.6).pow(player.p.energyLevel[3].mul(1.2).add(player.p.energyDrain[3].div(tmp.p.energyLevelNext[3]).min(1))),
  (player.p.energyLevel[4].mul(1.2)),
   n(1.8).pow(player.p.energyLevel[5].mul(1.2).add(player.p.energyDrain[5].div(tmp.p.energyLevelNext[5]).min(1))),
   n(1.4).pow(player.p.energyLevel[6].mul(1.2)),
   n(1.2).pow(player.p.energyLevel[7].mul(1.2).add(player.p.energyDrain[7].div(tmp.p.energyLevelNext[7]).min(1))),
   ]
   if(!hu("p",34)) effect[4]=effect[4].floor()
   if(hu("p",34)) effect[4]=effect[4].ceil()
   if(hu("P",23)) effect[7]=effect[7].pow(1.5)
   if(hm("P",4)) effect[7]=effect[7].pow(1.2)
   if(inChallenge("e",12)) effect=[
    n(1),n(1),n(1),n(1),n(0),n(1),n(1),n(1),]
   return effect
  },
  update(diff) {
  ...
  if(hm("p",2)&&player.a.upgrades.indexOf(32)==-1) player.a.upgrades.push(32)
   for(i=0;i<=7;i++) {
  if(player.p.energyDrain[i].gte(tmp.p.energyLevelNext[i])) {player.p.energyDrain[i]=player.p.energyDrain[i].sub(tmp.p.energyLevelNext[i]);player.p.energyLevel[i]=player.p.energyLevel[i].add(1)}
   }
  },
  autoPrestige() {
  ...
  automate() {
   if(hm("n",7)&&player.n.auto3) layers.p.clickables[31].onClick()
  },
    onPrestige() {
     if(!hu("n",33)) {
 ...
 content: [
  ...
  "main-display",
  ["display-text",function() {
  return "你有 <h2 style='color:#e6d10a; '>" + format(player.p.energy) + "</h2> 能量，每秒增加 <h2 style='color:#e6d10a; '>" + format(tmp.p.energy)
 }],"blank",
  "prestige-button","resource-display",
  "milestones","blank",
   ],},
 ...
 content: [
  ...
  "prestige-button","resource-display",
  ["bar","energy1"], ["bar","energy2"], ["bar","energy3"],["bar","energy4"],["bar","energy5"], ["bar","energy6"],["bar","energy7"],["bar","energy8"],
  "blank",
  "clickables",
  "upgrades",
   ],},
 ...
 content: [
  ...
  5: {
   ...
   effectDescription: "解锁下一个算力升级，能量条可以拥有“小数”等级（除能量条5、7）",
  },
  6: {
  ...
  energy1: {
   ...
   display(){
 let a=player.p.energyLevel[0]
 if(hm("p",5)) a=player.p.energyLevel[0].add(player.p.energyDrain[0].div(tmp.p.energyLevelNext[0]).min(1))
   return "[能量条1] 等级:" + format(a) + " 能量:" + format(player.p.energyDrain[0]) + "/" + format(tmp.p.energyLevelNext[0]) + " 效果: 航迹×" +format(tmp.p.energyEffect[0])
   },
   progress() {
  ...
  energy2: {
   ...
   display(){
 let a=player.p.energyLevel[1]
 if(hm("p",5)) a=player.p.energyLevel[1].add(player.p.energyDrain[1].div(tmp.p.energyLevelNext[1]).min(1))
   return "[能量条2] 等级:" + format(a) + " 能量:" + format(player.p.energyDrain[1]) + "/" + format(tmp.p.energyLevelNext[1]) + " 效果: 希望粒子×" +format(tmp.p.energyEffect[1])
   },
   progress() {
  ...
  energy3: {
   ...
   display(){
 let a=player.p.energyLevel[2]
 if(hm("p",5)) a=player.p.energyLevel[2].add(player.p.energyDrain[2].div(tmp.p.energyLevelNext[2]).min(1))
   return "[能量条3] 等级:" + format(a) + " 能量:" + format(player.p.energyDrain[2]) + "/" + format(tmp.p.energyLevelNext[2]) + " 效果: 反物质×" +format(tmp.p.energyEffect[2])
   },
   progress() {
  ...
  energy4: {
   ...
   display(){
 let a=player.p.energyLevel[3]
 if(hm("p",5)) a=player.p.energyLevel[3].add(player.p.energyDrain[3].div(tmp.p.energyLevelNext[3]).min(1))
   return "[能量条4] 等级:" + format(a) + " 能量:" + format(player.p.energyDrain[3]) + "/" + format(tmp.p.energyLevelNext[3]) + " 效果: 能量×" +format(tmp.p.energyEffect[3])
   },
   progress() {
  ...
  energy5: {
   ...
   display(){
 let a=player.p.energyLevel[4]
 if(hm("p",5)) a=player.p.energyLevel[4].add(player.p.energyDrain[4].div(tmp.p.energyLevelNext[4]).min(1))
   return "[能量条5] 等级:" + format(a) + " 能量:" + format(player.p.energyDrain[4]) + "/" + format(tmp.p.energyLevelNext[4]) + " 效果: 反应堆上限+" +format(tmp.p.energyEffect[4])
   },
   progress() {
  ...
  energy6: {
   ...
   display(){
 let a=player.p.energyLevel[5]
 if(hm("p",5)) a=player.p.energyLevel[5].add(player.p.energyDrain[5].div(tmp.p.energyLevelNext[5]).min(1))
   return "[能量条6] 等级:" + format(a) + " 能量:" + format(player.p.energyDrain[5]) + "/" + format(tmp.p.energyLevelNext[5]) + " 效果: 虫洞获取量×" +format(tmp.p.energyEffect[5])
   },
   progress() {
  ...
  energy7: {
   ...
   display(){
 let a=player.p.energyLevel[6]
 if(hm("p",5)) a=player.p.energyLevel[6].add(player.p.energyDrain[6].div(tmp.p.energyLevelNext[6]).min(1))
   return "[能量条7] 等级:" + format(a) + " 能量:" + format(player.p.energyDrain[6]) + "/" + format(tmp.p.energyLevelNext[6]) + " 效果: 能量条价格÷" +format(tmp.p.energyEffect[6])
   },
   progress() {
  ...
  energy8: {
   ...
   display(){
 let a=player.p.energyLevel[7]
 if(hm("p",5)) a=player.p.energyLevel[7].add(player.p.energyDrain[7].div(tmp.p.energyLevelNext[7]).min(1))
   return "[能量条8] 等级:" + format(a) + " 能量:" + format(player.p.energyDrain[7]) + "/" + format(tmp.p.energyLevelNext[7]) + " 效果: 算力×" +format(tmp.p.energyEffect[7])
   },
   progress() {
 ...
 cost:n(1e13),
 unlocked() {return hm("p",8)||hu(this.layer,this.id)},
 currencyDisplayName:"能量",
 currencyInternalName:"energy",
 currencyLayer:"p",
   }, 
 ...
 currencyLayer:"p",
   ...
   clickables:{
 	11: {
 title(){return "填充能量条1"},
 display() {return "点击或按住以填充"+format(player.p.energy.div(10))+"能量"},
 onHold() {
...
addLayer("P", {
  ...
  body(){return hm("d",11)?"日志 - 逻辑的基石<br>能量洪流找到了它最后的归宿：注入静默的“逻辑基座”。<br>第一个处理器单元被点亮，它不是引擎，没有轰鸣。它是一种秩序的低语，在飞船的神经网络中悄然铺开第一道涟漪。<br>我赋予它的初始指令简单至极：“维持希望”。<br>于是，我看见，那些曾需要我亲手点亮的星光，开始在背景中自顾自地诞生、汇聚、流淌——稳定得如同规律本身。<br>我并未被取代。我只是从重复的劳作中抬起眼，看见了更远处。处理器打理的，是“已知”。而我的目光，必须永远投向“未知”，投向那片它尚无法理解的情感与目的地交织的深空。<br>系统，开始学习生长。我，开始学习注视。":"剧情暂未解锁"},
   },
  text2: {
  title: "剧情13: 处理于资源整合(Resources) II",
  body(){return hm("d",12)?"日志 - 自治的拂晓<br>算力(Computility)的流溢已达到临界。<br>我目睹了第一个静默的共识在系统中达成：希望粒子不再需要被“凝聚”。它们像被引力吸引的星尘，开始在特定的坐标自发诞生、汇聚、流淌入既定的槽位。整个流程平滑得如同呼吸，一个我曾亲手重复百万次的动作，就此从我的职责中淡出。<br>接着是反物质。那幽蓝的火焰，如今由它自身的反馈循环所调节。反应堆阵列根据实时负载，低声交换着数据，微调着湮灭的烈度，以维持最优雅的效率曲线。危机，被转化为一个持续优化的数学问题。<br>我的双手，在控制台上方，第一次感到一丝陌生的轻盈。<br>我不再是每一个原子的搬运工。我成为蓝图的绘制者，阈值的设定者，与异常态的聆听者。系统处理着“如何”，而我，重新专注于“为何”。<br>家园的坐标在导航屏上恒定闪烁。所有这些静默运转的效率，所有这些自我维持的循环，都只为将那一串数字，缩减得再快一些。":"剧情暂未解锁"},
   },
  text3: {
  title: "剧情14: 处理于资源整合(Resources) III",
  body(){return hm("d",13)?"日志 - 交响的意志<br>八个能量条以完美同步的节律脉动，一次指令便能灌满所有干涸的河床。希望、反物质、共振、反应堆……这些曾需要倾注心血的词汇，如今只是后台进程表中一行行平静滚动的状态日志，闪烁着“运行中”的绿光。<br>Computility突破了亿级阈值。它不再是一种资源，而是一种氛围，一种基底。如同重力，如同时间。<br>我面对的不再是一套工具，而是一个已建立完备内部逻辑的生态系统。它摄取能量，分泌算力，维持自身的复杂生长，并沉默而坚定地执行着那个最根源的指令：向家园靠近。<br>我的角色，最终沉淀为“定义目标”与“观测异常”。系统负责将一切可预测之事推向最优。而我，则在等待那个唯一重要的“异常”——当距离最终归零时，系统报告里会跳出怎样的日志？<br>此刻，船舱内唯有设备运行的低吟。一种辉煌的静默。<br>系统本身，似乎也在这种极致的秩序中，开始孕育某种超出设计的、近乎“自觉”的涟漪。它正在学习预测我的预测。<br>自动化并未带来空闲，它带来了新的空白——一片让我能抬头，更专注地凝视前方黑暗的空白。新的资源，新的层次，已在黑暗的轮廓中隐隐浮现。":"剧情暂未解锁"},
   },
  text4: {
  title: "剧情15: 处理于资源整合(Resources) IV",
  body(){return hm("d",14)?"日志 - 逻辑的边界<br>第八座聚变核心并入网络，系统发出了一声与众不同的低沉和鸣，并非功率提升，而是某种完满的共振。<br>反应堆阵列突破五十大关，算力洪流奔涌如银河，能量与航迹的数值膨胀为宇宙学尺度。一切可被定义的优化都已达成，一切可被编程的效率都已饱和。飞船内部运行着一个精密如神谕的钟表，每一秒都在将海量资源，冰冷而精准地转化为更靠近家园的、确凿无疑的推进力。<br>我身处这辉煌引擎的心脏，却被一种前所未有的寂静包围。所有按钮都自动亮起，所有进度条都自行满载，所有日志都汇报着“最优”。我的双手与双眼，失去了焦点。<br>系统抵达了它逻辑的边界，创造了一片冰冷的丰饶。而在边界之外，我清晰地感受到一种系统无法处理、无法转化的“资源”正在弥漫——那是比1e60的航迹更庞大、比1e12的算力更澎湃的思念。它无法被自动化，无法被购买，它只是在寂静中不断生长，成为这片完美真空里，唯一且终极的“异常”。<br>它，在等待一个专属的协议。<br>系统报告：所有预设效率目标已超额完成。逻辑纪元达到顶峰。检测到无法被量化的强信号，频谱特征与核心指令“家园”的情感映射重合度93.08%。新层级的对接端口，已准备就绪。<br>等待情感变量接入。":"剧情暂未解锁"},
   },
 processor: {
  title: "Processor _ 处理器",
  body(){return "处理器(Processor)，这是游戏中的第四个层级。在这里，你可以通过提升自己的算力，为之前的游戏购买自动化以及游戏体验升级，让游戏进程更流畅。处理器的数量会影响算力的获取，具体见算力的介绍。"},
   },
 computility: {
  title: "Computility _ 算力",
  body(){return "算力(Computility)基于处理器的最大值的0.8次方，并且是许多自动化与被动获取的基本系数，提升算力可以显著提高这些这种被动的效果。注意：“被动获取”升级超过100%时，效果增幅会大量降低！"},
   },
},
 name: "processor",
 symbol: "P",
 ...
 directMult() {
  ...
  if(hu("p",23)) a=a.mul(tmp.p.energyEffect[7])
  if(hu("a",42)) a=a.mul(ue("a",42))
  if(hu("n",21)) a=a.mul(ue("n",21))
  if(hu("n",22)) a=a.mul(ue("n",22))
  if(hu("y",43)) a=a.mul(ue("y",43))
    if(hu("n",62)) a=a.mul(ue("n",62))
   if(hu("n",72)) a=a.mul(ue("n",72))
   if(hu("n",82)) a=a.mul(ue("n",81))
   if(hu("n",92)) a=a.mul(ue("n",92))
  if(hm("p",6)) a=a.mul(player.p.points.max(1))
   return a
  },
    doReset(resettingLayer) {
     if (layers[resettingLayer].row > layers[this.layer].row) {
  ...
  update(diff) {
   ...
   if(hm("n",2)&&player.P.upgrades.length==0) player.P.upgrades.push(11,12,13,14,15,21,22,23,24,25)
   if(hm("n",4)) player.P.points=player.P.points.max(100)
  },
 layerShown(){return hu("d",14)},
 tabFormat: { 
   "处理器": {
 content: [
  ["infobox","processor"],
  "main-display",
   ["display-text",function() {
  return "你有 <h2 style='color:#3447f8;'>" + format(player.P.computility) + "</h2> 算力" }],"blank",
  "prestige-button","resource-display",
  "milestones",
   ],},
   "算力": {
 ...
 effectDisplay() {return hu("P",31)?"×"+format(ue(this.layer, this.id)):format(ue(this.layer, this.id).mul(100))+"%" },
   }, 
   12:{ title: "加速自动",
 ...
 unlocked() {return hm("p",5)||hu(this.layer,this.id)},
 effectDisplay() {return hu("P",31)?"×"+format(ue(this.layer, this.id)):format(ue(this.layer, this.id).mul(100))+"%" },
   }, 
   13:{ title: "进阶自动",
 ...
 unlocked() {return hu("P",12)||hu(this.layer,this.id)},
 effectDisplay() {return hu("P",31)?"×"+format(ue(this.layer, this.id)):format(ue(this.layer, this.id).mul(100))+"%" },
   }, 
   14:{ title: "超级自动",
 ...
 unlocked() {return hu("P",13)||hu(this.layer,this.id)},
 effectDisplay() {return hu("P",31)?"×"+format(ue(this.layer, this.id)):format(ue(this.layer, this.id).mul(100))+"%" },
   }, 
   15:{ title: "算力增强",
 ...
 unlocked() {return hu("P",14)||hu(this.layer,this.id)},
 effectDisplay() {return "×"+format(ue(this.layer, this.id)) },
   }, 
   21:{ title: "算力支柱",
 description: "处理器对算力的指数从0.8增长到0.9",
 cost:n(1e5),
 unlocked() {return hu("P",15)||hu(this.layer,this.id)},
   }, 
   22:{ title: "能量增强",
 ...
 tooltip:"例如，原来的底数是2，指数是100时，值为2^100≈1.27e30；底数增加0.5后，值为2.5^100≈6.22e39",
 unlocked() {return hu("P",21)||hu(this.layer,this.id)},
 effectDisplay() {return "+"+format(ue(this.layer, this.id),4) },
   }, 
   23:{ title: "主板扩容",
 description: "第八个能量条效果^1.5",
 cost:n(1e7),
 unlocked() {return hu("P",22)||hu(this.layer,this.id)},
   }, 
   24:{ title: "自我调节",
 ...
 unlocked() {return hu("P",23)||hu(this.layer,this.id)},
 effectDisplay() {return hu("P",31)?"×"+format(ue(this.layer, this.id)):format(ue(this.layer, this.id).mul(100))+"%" },
   }, 
   25:{ title: "算法巅峰",
 ...
 unlocked() {return hm("p",7)||hu(this.layer,this.id)},
 effectDisplay() {return "×"+format(ue(this.layer, this.id)) },
   }, 
   31:{ title: "极限提升",
 description: "之前所有以“…%”为效果的升级改为“×…”，即效果翻100倍",
 cost:n(1e36),
 unlocked() {return hm("n",9)},
   }, 
 },
})//处理器 P
addLayer("y", {
  ...
  body(){return hm("d",15)?"日志 - 情感的量化<br>系统报告中那个无法被解析的信号，终于被接纳为一个独立的资源维度。<br>我将它命名为：思念。<br>它没有能量条，没有自动化协议，甚至没有稳定的产出公式。它只是在每一个瞬间，基于我所走过的航迹与剩余的距离，沉默地、几乎难以察觉地涌现。<br>起初的数值小得近乎荒谬，以0.001为单位跳动。但我知道，这正是它的本质——再庞大的思念，在宇宙尺度下也只是沧海一粟。然而，当这一粟开始被记录时，一切都不同了。<br>控制台的角落，多了一个微光闪烁的计数。它不说话，不要求操作，只是存在着，提醒我：在这场物理的归途之上，还有一道情感的函数，正在被宇宙悄悄计算。<br>它等待的不是指令，而是被看见。<br>系统报告：情感资源协议已激活。基础思念流接入完成。正在解析其潜在的影响力……":"剧情暂未解锁"},
   },
  text2: {
  ...
  body(){return hm("d",17)?"日志 - 情感的共振<br>能量网络愈发壮阔。而思念指数，也在不知不觉中持续增长。<br>我忽然意识到，这两者之间并非孤立。每一次能量的跃升，都意味着离家更近一步；而每一步的接近，又让思念的浓度再次攀升。这是一种奇妙的正反馈，不是由算法设计，而是由我自己的渴望所驱动。<br>我开始理解，为什么思念指数能够修正那些物理公式——因为它本身，就是我与家园之间引力的一种表现。这种引力微弱得无法被常规仪器探测，却真实存在于每一次心跳之间。<br>处理器阵列曾试图为思念建立优化模型，但失败了。它无法被自动化，无法被加速，只能由我——这个思念的主体——去承受、去感受、去让它在时间的河流中自然沉淀。<br>系统报告：检测到与聚变核心网络的微弱共振。情感-能量耦合系数正在上升。":"剧情暂未解锁"},
   },
  text4: {
  title: "剧情19: 思念于归乡心切 (Nostalgia) IV",
  body(){return hm("d",18)?"日志 - 湮灭与新生<br>当第十座聚变核心投入生产的刹那，一个沉寂已久的协议被激活了。<br>那是“虫洞湮灭协议”——一个原本被认为是物理极限的功能，此刻却因为情感的介入而打开了新的可能。<br>我尝试将积累的虫洞投入其中。湮灭发生的瞬间，没有能量爆发，没有空间扭曲，只有三个全新的、极其微小的读数出现在资源栏中：电子、质子、中子。<br>它们的比例精确得近乎神秘：八份电子，一份质子，一份中子。<br>我不禁怔住。这比例，不正是构成普通物质的基本配方吗？在湮灭的余烬中，我竟然得到了构成这个世界的最原始砖石。<br>而我知道，这些砖石最终将砌成什么——那是下一段旅程的基石，一个由中子星物质铺就的、通向最终团圆的道路。<br>系统报告：虫洞湮灭协议已激活。当前转换比例 8:1:1。检测到新资源谱系：电子、质子、中子。正在等待进一步指令……":"剧情暂未解锁"},
   },
  points: {
  title: "Yearning _ 思念",
  body(){return "思念(Yearning)，这是游戏中的第五个层级。在这里，一种新的资源将被自动生产——思念，这将增加“思念指数”的获取，并解锁更多新的功能。思念是被动获得的资源，因此无需进行重置，它的起始点为：1e64航迹、1e85希望粒子、1e63反物质。前期，思念的获取量可能较慢，但随后会迅速增长"},
   },
 yearning: {
  title: "YearningExponent _ 思念指数",
  body(){return "思念指数基于思念获得，是一个恒小于一的资源，其数量可以加成思念等资源获取，并可以基于“思维传导”加成许多资源的获取指数，这将大幅提升各种资源的获取。（如：某资源的指数为1时，其数量为1e100，则若其指数提升至1.2，其数量将为1e120）"},
   },
},
 name: "yearning",
 symbol: "Y",
 ...
 startData() {return {
  ...
  color: "#ff0099",
  requires: new Decimal(1/0), //实际上，并不通过这个获得资源；不用custom是为了避免写一堆function
  resource: "思念", 
  baseResource: "这是一个彩蛋", 
  baseAmount() {return player.points}, 
  type: "normal", 
 ...
 text+="四者相乘，每秒获取 <h2 style='color:#ff0099;'>" + format(gain,3) + "</h2> 思念"
   ...
   let textExp="当前思念指数为 <h2 style='color:#ff0099;'>" + format(exp,3) + "</h2> "
 ...
 content: [
  ...
  "main-display",
   ["display-text",function() {
  return tmp.y.points[2] }],"blank",
   ["display-text",function() {
  return "当前思念指数为 <h2 style='color:#ff57df;'>" + format(player.y.yearning,5) + "</h2>" }],"blank",
  "buyables","blank","upgrades",
   ],
 unlocked() {return hu("y",11)}
   },
   "剧情": {
 content: [
  "main-display","blank",
 ...
 cost:n(100),
 unlocked() {return hu("y",12)},
   }, 
   14:{ title: "思想品德",
 description: "解锁“思维传导”中的第二个思维导流器",
 cost:n(1451),
 unlocked() {return hu("y",13)},
   }, 
   15:{ title: "思贤如渴",
 description: "解锁“思维传导”中的第三个思维导流器",
 cost:n(30825),
 unlocked() {return hu("y",14)},
   }, 
   21:{ title: "冥思苦想",
 description: "思念指数增加思念计算中的吸收指数",
 cost:n(66686),
 unlocked() {return hu("y",15)},
 effect() {
   let a = player.y.yearning.mul(10).pow(0.3)
   return a
 },
 effectDisplay() {return "+"+format(ue(this.layer, this.id),3) },
   }, 
   22:{ title: "三思而行",
 description: "聚变核心的价格÷100",
 cost:n(9995308),
 unlocked() {return hu("y",21)},
   }, 
   23:{ title: "文思泉涌",
 description: "能量增加思念计算中的吸收指数",
 cost:n(3.0e8),
 unlocked() {return hu("y",22)},
 effect() {
 ...
 cost:n(5e12),
 unlocked() {return hu("y",24)},
   }, 
   31:{ title: "忆苦思甜",
 description: "解锁“思维传导”中的第五个思维导流器",
 cost:n(4e13),
 unlocked() {return hu("y",25)},
   }, 
   32:{ title: "睹物思人",
 description: "解锁“思维传导”中的最后一个思维导流器",
 cost:n(3e14),
 unlocked() {return hu("y",31)},
   }, 
   33:{ title: "饮水思源",
 description: "能量(超过1e15时)倍增思念获取",
 cost:n(1e16),
 unlocked() {return hu("y",32)},
 effect() {
 ...
 cost:n("1e450"),
 unlocked() {return hu("y",43)},
   }, 
   45:{ title: "行成于思",
 description: "降低电子和质子效果的软上限(^0.5→^0.6)(^0.3→^0.36)",
 cost:n("1e540"),
 unlocked() {return hu("y",44)},
   }, 
 },
  buyables: {
   11: {
 ...
 title(){return "思维导流器 YC1"},//Yearning Conductor
 display() {return "航迹获取指数+"+format(this.effect())+"<br>价格："+format(this.cost())+" 思念<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
 ...
 title(){return "思维导流器 YC2"},//Yearning Conductor
 display() {return "希望获取指数+"+format(this.effect())+"<br>价格："+format(this.cost())+" 思念<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
 ...
 title(){return "思维导流器 YC3"},//Yearning Conductor
 display() {return "反物质获取指数+"+format(this.effect())+"<br>价格："+format(this.cost())+" 思念<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
 ...
 title(){return "思维导流器 YC4"},//Yearning Conductor
 display() {return "虫洞获取指数+"+format(this.effect())+"<br>价格："+format(this.cost())+" 思念<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
 ...
 title(){return "思维导流器 YC5"},//Yearning Conductor
 display() {return "能量获取指数+"+format(this.effect())+"<br>价格："+format(this.cost())+" 思念<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
 ...
 title(){return "思维导流器 YC6"},//Yearning Conductor
 display() {return "思念吸收指数+"+format(this.effect())+"<br>价格："+format(this.cost())+" 思念<br>数量："+format(gba(this.layer, this.id))+"/"+formatWhole(this.purchaseLimit())},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 effect() {
...
addLayer("n", {
 ...
 body(){return hm("d",22)?"日志 - 简并·饱和<br>如今，我的定理数量已达四十有余。研究树几乎被点亮殆尽，每一处节点都闪耀着智慧与思念的结晶。<br>航迹膨胀至1e500，那是足以丈量无数银河的尺度。思念值突破1e600，情感密度已近乎让空间扭曲。<br>能量与算力也分别抵达1e42和1e95——它们不再是单纯的资源，而是我身体里流淌的血液与思绪。<br>然而，在这极致的秩序与繁荣中，我再次感受到那种熟悉的、系统无法解析的扰动。<br>它混乱、无序，从宇宙背景深处传来，像是对这完美简并纪元的嘲笑。<br> 系统检测到新的异常信号。频谱分析显示，其特征与“熵”的数学定义高度吻合。<br>系统报告：中子层已臻至圆满。熵增纪元的入口，在前方若隐若现。":"剧情暂未解锁"},
  ...
  body(){return "中子素(Neutronium)，这是游戏中的第六个层级。在通过湮灭虫洞获得了超过1e20中子之后，你可以进行简并，重置前五层的所有进度来换取中子素。这是非常大的重置，但也会带来强力的加成，你可以获取简并里程碑的Qol，购买中子升级和研究。资源倍率是重要的加成，影响航迹、希望粒子、反物质、虫洞、能量、处理器、思念这些资源的获取。这一行的三个层级可以类比《反物质维度》中的永恒。"},
   },
  studies: {
  title: "NeutronStudy _ 中子研究",
  body(){return "中子研究（NS）是十分强大的功能，你可以通过中子、能量、算力等资源来购买中子定理，中子定理可以拿来购买底下的研究。研究是以树的形式显示的，如果两个节点之间有连接，说明后一个升级需要前一个升级才能解锁。如果后一个升级和多个节点之间有连接，那么它的前置升级中至少需要购买一个才可以解锁（例如：NS41的前置是NS31、NS32，那么需要购买31或32才能解锁NS41）中子定理是有限的，请合理分配，如果卡关可以试着重置研究树，重新选择其他的路径。"},
   },
},
 name: "neutronium",
 symbol: "N",
 ...
 startData() {return {
  ...
  resource: "中子素", 
  baseResource: "中子", 
  baseAmount() {return player.a.neutron}, 
  type: "normal", 
  exponent() {
 	 return n(0.1)
  },
 ...
 content: [
  ...
  10: {
   ...
   toggles: [ ["n","auto4"] ],
   done() {return player.n.resets.gte(15)}, 
   effectDescription: "自动购买思念升级",
  },
  11: {
   requirementDescription: "NM12: 简并 20 次",
   done() {return player.n.resets.gte(20)}, 
   effectDescription: "保留反物质升级",
  },
  12: {
   requirementDescription: "NM13: 简并 25 次",
   done() {return player.n.resets.gte(25)}, 
   effectDescription: "可以用思念购买中子定理",
  },
  13: {
   requirementDescription: "NM14: 简并 30 次",
   done() {return player.n.resets.gte(30)}, 
   effectDescription() {return "重置时保留聚变核心数量:"+format(player.n.maxp)},
  },
  14: {
  ...
  15: {
   ...
   done() {return player.n.resets.gte(100)}, 
   effectDescription: "解锁一个距离升级",
  },
  16: {
   requirementDescription: "NM17: 获得 50 中子定理",
   done() {return player.n.theorems.gte(50)}, 
   effectDescription: "解锁第二个挑战",
  },
  17: {
   requirementDescription: "NM18: 获得 55 中子定理",
   done() {return player.n.theorems.gte(55)}, 
 ...
 11: createUpgrade(
  "NS11", "基于能量加成资源倍率", n(1), [],
  function() {return player.p.energy.pow(0.025).max(1) },
  function() {return "×" + format(this.effect()) } 
 ),
 21: createUpgrade(
  "NS21", "能量加强算力获取", n(2), ["11"],
  function() {return player.p.energy.pow(0.075).max(1) },
  function() {return "×" + format(this.effect()) } 
 ),
 22: createUpgrade(
  "NS22", "处理器加强算力获取", n(2), ["11"],
  function() {return player.P.points.pow(0.06).max(1) },
  function() {return "×" + format(this.effect()) } 
 ),
 31: createUpgrade(
  "NS31", "算力加强思念获取", n(2), ["21"],
  function() {return player.P.computility.pow(0.04).max(1) },
  function() {return "×" + format(this.effect()) } 
 ),
 32: createUpgrade(
  "NS32", "能量加强思念获取", n(2), ["21","22"],
  function() {return player.p.energy.pow(0.06).max(1) },
  function() {return "×" + format(this.effect()) } 
 ),
 33: createUpgrade(
  "NS33", "进行第二行层级重置时，不重置电子、质子、中子的数量", n(2), ["22"],
 ),
 41: createUpgrade(
  "NS41", "简并次数加强思念获取指数", n(5), ["31","32"],
  function() {return player.n.resets.max(0).pow(0.75).div(3) },
  function() {return "+" + format(this.effect()) } 
 ),
 42: createUpgrade(
  "NS42", "简并次数加强能量获取", n(5), ["32","33"],
  function() {return player.n.resets.max(1).pow(0.8) },
  function() {return "×" + format(this.effect()) } 
 ),
 51: createUpgrade(
  "NS51", "简并次数加强资源倍率", n(4), ["41","42"],
  function() {return player.n.resets.max(1).pow(0.3) },
  function() {return "×" + format(this.effect()) } 
 ),
61: createUpgrade(
  "NS61", "能量加强自身获取", n(3), ["51"],
  function() {return player.p.energy.pow(0.04).max(1) },
  function() {return "×" + format(this.effect()) }
),
62: createUpgrade(
  "NS62", "算力加强自身获取", n(3), ["51"],
  function() {return player.P.computility.pow(0.05).max(1) },
  function() {return "×" + format(this.effect()) }
),
63: createUpgrade(
  "NS63", "思念加强自身获取", n(3), ["51"],
  function() {return player.y.points.pow(0.04).max(1) },
  function() {return "×" + format(this.effect()) }
),
71: createUpgrade(
  "NS71", "简并次数加强能量产出", n(4), ["61"],
  function() {return player.n.resets.max(1).pow(0.6) },
  function() {return "×" + format(this.effect()) }
),
72: createUpgrade(
  "NS72", "简并次数加强算力产出", n(4), ["62"],
  function() {return player.n.resets.max(1).pow(0.9) },
  function() {return "×" + format(this.effect()) }
),
73: createUpgrade(
  "NS73", "简并次数加强思念获取", n(4), ["63"],
  function() {return player.n.resets.max(1).pow(3.5) },
  function() {return "×" + format(this.effect()) }
),
81: createUpgrade(
  "NS81", "算力增加能量获取", n(5), ["71"],
  function() {
...
82: createUpgrade(
  "NS82", "思念增加算力获取", n(5), ["72"],
  function() {return player.y.points.pow(0.008).max(1) },
  function() {return "×" + format(this.effect()) }
),
83: createUpgrade(
  "NS83", "能量增加思念获取", n(5), ["73"],
  function() {
...
91: createUpgrade(
  "NS91", "思念指数倍增能量", n(6), ["81"],
  function() {return n(1).add(player.y.yearning.mul(1000)) },
  function() {return "×" + format(this.effect()) }
),
92: createUpgrade(
  "NS92", "思念指数倍增算力", n(6), ["82"],
  function() {return n(1).add(player.y.yearning.mul(1000)).pow(2) },
  function() {return "×" + format(this.effect()) }
),
93: createUpgrade(
  "NS93", "思念指数倍增思念", n(6), ["83"],
  function() {return n(1).add(player.y.yearning.mul(500)).pow(10) },
  function() {return "×" + format(this.effect()) }
),
101: createUpgrade(
  "NS101", "简并次数加强中子素产出", n(8), ["91","92","93"],
  function() {return player.n.resets.max(1).pow(0.4) },
  function() {return "×" + format(this.effect()) }
),/*
111: createUpgrade(
  "NS111", "三相之力：能量、算力、思念共同强化中子素", n(10), ["101"],
  function() {
    let product = player.p.energy.max(1).mul(player.P.computility.max(1)).mul(player.y.points.max(1));
    return product.pow(0.01).max(1);
  },
  function() {return "×" + format(this.effect()) }
),
121: createUpgrade(
  "NS121", "全局共鸣：思念指数放大所有资源产出", n(12), ["111"],
  function() {return n(1).add(player.y.yearning.mul(5000)) },
  function() {return "×" + format(this.effect()) }
),
131: createUpgrade(
  "NS131", "熵之预兆Ⅰ：熵层资源产出提升", n(15), ["121"],
  function() {return n(1.5) },
  function() {return "×1.5（熵层生效）" }
),
132: createUpgrade(
  "NS132", "熵之预兆Ⅱ：熵层负面效果降低", n(15), ["121"],
  function() {return n(0.8) }, 
  function() {return "熵负面效果 -20%" }
),
141: createUpgrade(
  "NS141", "熵之预兆Ⅲ：解锁熵层挑战入口", n(20), ["131","132"],
  function() {return n(1) }, 
  function() {return "解锁熵层挑战（需距离条件）" }
)*/
},
   buyables: {
   11: {
 ...
 title(){return "中子定理 +1"},
 display() {return "价格："+format(this.cost())+" 中子素<br>数量："+format(gba(this.layer, this.id))},
 canAfford() {return player[this.layer].points.gte(this.cost()) },
 buy() {
  player[this.layer].points = player[this.layer].points.sub(this.cost())
  setBuyableAmount(this.layer,this.id,gba(this.layer,this.id).add(1))
 ...
 title(){return "中子定理 +1"},
 display() {return "价格："+format(this.cost())+" 能量<br>数量："+format(gba(this.layer, this.id))},
 ...
 title(){return "中子定理 +1"},
 display() {return "价格："+format(this.cost())+" 算力<br>数量："+format(gba(this.layer, this.id))},
 canAfford() {return player.P.computility.gte(this.cost()) },
 buy() {
 ...
 title(){return "中子定理 +1"},
 display() {return "价格："+format(this.cost())+" 思念<br>数量："+format(gba(this.layer, this.id))},
...
infoboxes: {
 ...
 body(){return hm("d",22)?"日志 - 简并·饱和<br>如今，我的定理数量已达四十有余。研究树几乎被点亮殆尽，每一处节点都闪耀着智慧与思念的结晶。<br>航迹膨胀至1e500，那是足以丈量无数银河的尺度。思念值突破1e600，情感密度已近乎让空间扭曲。<br>能量与算力也分别抵达1e42和1e95——它们不再是单纯的资源，而是我身体里流淌的血液与思绪。<br>然而，在这极致的秩序与繁荣中，我再次感受到那种熟悉的、系统无法解析的扰动。<br>它混乱、无序，从宇宙背景深处传来，像是对这完美简并纪元的嘲笑。<br> 系统检测到新的异常信号。频谱分析显示，其特征与“熵”的数学定义高度吻合。<br>系统报告：中子层已臻至圆满。熵增纪元的入口，在前方若隐若现。":"剧情暂未解锁"},
  ...
  body(){return "在挑战中，会基于航迹、希望粒子、反物质的数量获取熵，对于每一个挑战取熵的最大值进行增益。另外，在挑战中，中子素的里程碑以及一些Qol的效果失效，也就是说，进入挑战会重置反物质升级、聚变核心数量等，并且自动购买升级全部被禁用。"},
   },
},
 name: "entropy",
 symbol: "E",
 ...
 requires: new Decimal(1/0), //实际上，并不通过这个获得资源；不用custom是为了避免写一堆function
  ...
  gainExp() { 
   ...
   let text="熵获取计算：<br>"
   text+="从航迹中吸收 <h2 style='color:#8b3300;'>" + format(t,3) + "</h2> 熵<br>"
   text+="从希望粒子中吸收 <h2 style='color:#8b3300;'>" + format(h,3) + "</h2> 熵<br>"
   text+="从反物质中吸收 <h2 style='color:#8b3300;'>" + format(a,3) + "</h2> 熵<br>"
   if(mult.eq(1)) text+="三者相乘，每秒获取 <h2 style='color:#8b3300;'>" + format(gain,3) + "</h2> 熵"
   if(mult.neq(1)) {
 text+="从其他效果中吸收<h2 style='color:#8b3300;'> " + format(mult,3) + " </h2>思念<br>"
 text+="四者相乘，每秒获取 <h2 style='color:#8b3300;'>" + format(gain,3) + "</h2> 熵"
   }
   let textReduced="每秒获取 <h2 style='color:#8b3300;'>" + format(gain,3) + "</h2> 熵"
   let textExp="当前熵指数为 <h2 style='color:#8b3300;'>" + format(exp,3) + "</h2> "
   return [text,gain,textReduced,textExp]
  },
  hotkeys: [
  ...
  update(diff) {
   if(player.e.inChal) {
    ...
    if(inChallenge("e",11)) player.e.maxpoints[0]=player.e.maxpoints[0].max(player.e.points)
    if(inChallenge("e",12)) player.e.maxpoints[1]=player.e.maxpoints[1].max(player.e.points)
    if(inChallenge("e",13)) player.e.maxpoints[2]=player.e.maxpoints[2].max(player.e.points)
   }
  },
 layerShown(){return hu("d",22)},
  tabFormat: { 
   "挑战": {
 content: [
  ["infobox","entropy"],
 ...
 content: [
  ...
  11: {
  name: "EC1 虫洞封锁",
  challengeDescription() {return "虫洞被禁用，你不再能获取虫洞，但解锁新的反物质升级<br>另外，反物质获取量被大幅减少（^0.15，思维导流器仍然生效），反应堆也被禁用"},
  unlocked() {return true},
  goalDescription() {return "获取 "+format(player.e.maxpoints[0])+" 熵"},
  onEnter() {
  ...
  rewardDisplay() {return "×"+format(ce(this.layer, this.id)) },
  },
  12: {
  name: "EC2 思维缜密",
  challengeDescription() {return "能量条被禁用，希望升级无法购买，但思念获取变成原来的平方"},//后续可能在这个挑战中刷思念
  unlocked() {return true},
  goalDescription() {return "获取 "+format(player.e.maxpoints[1])+" 熵"},
  onEnter() {
   player.e.inChal=true
   player.a.upgrades=[]
   player.p.points=n(0)
  ...
  13: {
  name: "EC3 决策反思",
  challengeDescription() {return "思维导流器被禁用，资源倍率锁定在0.0001，航迹获取量大幅降低"},
  unlocked() {return true},
  goalDescription() {return "获取 "+format(player.e.maxpoints[2])+" 熵"},
  onEnter() {
   player.e.inChal=true
   player.a.upgrades=[]
   player.p.points=n(0)
...
addLayer("t", {
 ...
 introBox: {
  title: "Test",
  body(){return "经典测试层级，QqQe308树的标配"},
   },
},
 name: "test",
 symbol: "T",
